    ...
    render() {
        return (
            <View style={styles.container}>
                <Text style={{ color: '#FF7538', fontSize: 40, fontFamily: "Montserrat-Medium" }}>Sign Up</Text>
                ...
                <View style={{ marginTop: 25 }}>
                    <Text style={{ fontFamily: "Montserrat-Medium" }}> Already have an account? <Text onPress={() => this.props.navigation.navigate('Login')} style={{ color: '#FF7538', fontSize: 18, fontFamily: "Montserrat-Medium" }}> Log In </Text></Text>
                </View>
            </View>
        )
    }
